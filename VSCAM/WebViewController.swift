...
//
//        self.navigationController?.addGradientBackground()
...
//        _progressView.autoresizingMask = UIViewAutoresizing(
//            rawValue: UIViewAutoresizing.flexibleWidth.rawValue | UIViewAutoresizing.flexibleTopMargin.rawValue
//        )
//    }
//
...
//
//        if let tryTitle = webView.stringByEvaluatingJavaScript(from: "document.title"), (false == isEmpty(tryTitle)) {
//            self.title = tryTitle
//        } else {
//            self.title = "加载中"
//        }
...
//            barButtonSystemItem: .refresh, target: self, action: #selector(UIViewController.naviButtonClick(_:))
//        )
...
//
//    //导航栏按钮按下
//    override func naviButtonClick(_ button: UIBarButtonItem) {
//        super.naviButtonClick(button)
//
//        webView.reload()
//    }
//}
